...
import { ShieldCheck, Zap, Rocket, Globe, Mail } from "lucide-react";
import SEOHead from "../components/SEOHead";

const stats = [
  { label: "Free Utilities", value: "140+" },
...
const values = [
  {
    icon: ShieldCheck,
    title: "Privacy First",
    desc: "All our tools run directly in your browser. Your data never leaves your device or touches external servers.",
  },
  {
    icon: Zap,
    title: "Always Free",
    desc: "Every single tool on UtilsFlow is free to use — no hidden fees, no subscriptions, no credit cards required.",
  },
  {
    icon: Rocket,
  ...
  },
  {
    ...
    desc: "From students and developers to designers and businesses — UtilsFlow has a tool for every daily workflow.",
  },
];
      ...
      <div className="max-w-[860px] mx-auto">
        ...
        <div className="text-center mb-14">
          ...
          <p className="text-text-secondary text-lg leading-relaxed max-w-[640px] mx-auto">
            UtilsFlow is a free, privacy-first platform offering 140+ online utilities — from image converters and PDF tools to SEO analyzers and developer helpers. No login. No tracking. No cost. Ever.
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-16">
          {stats.map((s) => (
            <div
              key={s.label}
              className="bg-bg-card border border-border/80 rounded-2xl p-6 text-center hover:border-primary/30 hover:bg-bg-card-hover transition-all duration-300"
            >
        ...
        {/* Mission */}
        <div className="bg-bg-card border border-border/80 rounded-2xl p-8 md:p-10 mb-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mb-14">
          {values.map((v) => {
            ...
            return (
              <div
                key={v.title}
                className="bg-bg-card border border-border/80 rounded-2xl p-6 hover:border-primary/30 hover:bg-bg-card-hover transition-all duration-300"
              >
